...
import static tech.artefficiency.logging.tools.formatter.formats.Slf4jFormatProcessorTest.Data.*;

public class Slf4jFormatProcessorTest {
    ...
    void process_singleParameter_formatsCorrectly() {
        ...
        then:
        {
            assertThat(target.process(SINGLE_PARAM_PATTERN, new Object[]{SINGLE_ARG}))
    ...
    void process_nullWithinParameters_preservesNull() {
        ...
        then:
        {
            assertThat(target.process(SINGLE_PARAM_PATTERN, new Object[]{null}))
